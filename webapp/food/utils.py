...
def daily_counter(today):
    ...
    return (
        daily_consumption_cals,
        daily_consumption_prots,
        daily_consumption_fats,
        daily_consumption_carbos,
    )
...
def graph_maker(days):
    ...
    plot = create_bar_chart(data, "days", "calories", hover)
...
def create_bar_chart(data, x_name, y_name, hover_tool=None, width=300, height=150):
    ...
    glyph = VBar(x=x_name, top=y_name, bottom=0, width=0.3, fill_color="#e12127")
